...
export default function HomePage(){
    ...
    return (
        <div className='homePageContainer'>
            ...
            <Typography className="titleDescription row3" variant="h4">Master your craft with leading mentors at your side.<br></br></Typography>
            <Typography className="titleDescription row4" variant="h4">Grow with every online mentoring session and take the next step in your career.<br></br></Typography>
            <Typography className="titleDescription row5" variant="h4">All on your terms, for a flat monthly price.</Typography>
